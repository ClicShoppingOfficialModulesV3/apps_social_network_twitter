<?php
  ...
  namespace ClicShopping\Apps\SocialNetwork\TwitterSN\Module\Hooks\ClicShoppingAdmin\Featured;
  ...
  class Insert implements \ClicShopping\OM\Modules\HooksInterface
  {
    ...
    public function __construct()
    {
      ...
      $this->app->loadDefinitions('Module/Hooks/ClicShoppingAdmin/Featured/Insert');
    ...
    public function execute()
    {
      ...
      if (isset($_POST['products_twitter'])) {
        if (($customers_group_id === 0)) {
          echo $this->SendTwitter($id, $this->app->getDef('text_new_featured_twitter', ['store_name' => STORE_NAME]));
        }
      }
    }
  }